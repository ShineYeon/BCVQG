...
class VQGWithCaptionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if not hasattr(self, 'images'):
            ...
            self.image_paths = self.vqg_data['image_paths']
        ...
        return image_path, image, question, answer, answer_type, qlength, alength, captions
...
def collate_fn_with_captions(data):
    ...
    """
    image_paths, images, questions, answers, answer_types, qlengths, alengths, captions = zip(*data)
    images = torch.stack(images, 0)

    return image_paths, images, questions, answers, answer_types, qlengths, alengths, captions
