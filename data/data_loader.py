...
class VQGDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (image, question, answer, answer_type, qlength, alength)
...
def collate_fn(data):
    ...
    """
    images, questions, answers, answer_types, qlengths, alengths = zip(*data)
    images = torch.stack(images, 0)

    return images, questions, answers, answer_types, qlengths, alengths
