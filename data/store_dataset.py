...
def init_tokenizer():
    ...
    # types = ['activity', 'animal', 'attribute', 'binary', 'color', 'count',
    #         'food', 'location', 'material', 'object', 'other', 'predicate',
    #         'shape', 'spatial', 'stuff', 'time']
    #
...
def save_dataset(image_dir, questions, annotations, ans2cat, output,
    ...
    d_img_path = h5file.create_dataset(
        "image_paths", (total_questions, 35), dtype='i'
    )
    ...
    bar = progressbar.ProgressBar(maxval=total_questions).start()
    i_index = 0
    q_index = 0
    done_img2idx = {}
    for entry in questions['questions']:
        ...
        path = "COCO_val2014_" + "%012d.jpg" % (image_id)
        ip, length = process_text_with_bert(path, tokenizer, max_length=35)
        d_img_path[q_index, :length] = ip


        q, length = process_text_with_bert(entry['question'], tokenizer,
                                 max_length=max_q_length)
        d_questions[q_index, :length] = q
        answer = qid2ans[question_id]
        a, length = process_text_with_bert(answer, tokenizer,
...
if __name__ == '__main__':
    ...
    # Inputs.
    parser.add_argument('--image-dir', type=str, default='/mnt/disk2/workspace/heeyeon/datasets/VQG_original/val2014',
                        help='directory for resized images')
    parser.add_argument('--questions', type=str,
                        default='/mnt/disk2/workspace/heeyeon/datasets/VQG_original/v2_Questions_Val_mscoco/v2_OpenEnded_mscoco_val2014_questions.json',
                        help='Path for train annotation file.')
    parser.add_argument('--annotations', type=str,
                        default='/mnt/disk2/workspace/heeyeon/datasets/VQG_original/v2_mscoco_val2014_annotations.json',
                        help='Path for train annotation file.')
    parser.add_argument('--cat2ans', type=str,
                        default='/mnt/disk2/workspace/heeyeon/datasets/VQG_original/iq_dataset.json',
                        help='Path for the answer types.')

    # Outputs.
    parser.add_argument('--output', type=str,
                        default='data/processed-new/iq_val_dataset_new.hdf5',
                        help='directory for resized images.')
    parser.add_argument('--cat2name', type=str,
                        default='data/processed-new/cat2name.json',
    ...
    # # Inputs.
    # parser.add_argument('--image-dir', type=str, default='/home/heeyeon/Documents/datasets/VQA2.0/val2014',
    #                     help='directory for resized images')
    # parser.add_argument('--questions', type=str,
    #                     default='/home/heeyeon/Documents/datasets/VQA2.0/v2_Questions_Val_mscoco/v2_OpenEnded_mscoco_val2014_questions.json',
    #                     help='Path for train annotation file.')
    # parser.add_argument('--annotations', type=str,
    #                     default='/home/heeyeon/Documents/datasets/VQA2.0/v2_mscoco_val2014_annotations.json',
    #                     help='Path for train annotation file.')
    # parser.add_argument('--cat2ans', type=str,
    #                     default='/home/heeyeon/Documents/datasets/VQA2.0/iq_dataset.json',
    #                     help='Path for the answer types.')
    #
    # # Outputs.
    # parser.add_argument('--output', type=str,
    ...
    #                     help='directory for resized images.')
    # parser.add_argument('--cat2name', type=str,
    #                     default='/home/heeyeon/Documents/datasets/VQA_split/cat2name_val.json',
    #                     help='Location of mapping from category to type name.')
    #
    # # Hyperparameters.
    # parser.add_argument('--im_size', type=int, default=224,
    ...
    save_dataset(args.image_dir, args.questions, args.annotations,
